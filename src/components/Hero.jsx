...
export default function Hero() {
  ...
  return (
    <section ref={heroRef} className="relative w-full h-screen flex flex-col items-center justify-center overflow-hidden bg-transparent">
      ...
      <div className="max-w-7xl mx-auto px-6 w-full text-center relative z-10 flex flex-col items-center pt-[100px]">
        <div ref={contentRef} className="flex flex-col items-center w-full">
          <div className="badge mb-20 shadow-lg px-6 py-2.5 bg-white/5 border border-white/10 rounded-full text-[10px] tracking-[0.2em] uppercase font-bold text-white/60" style={{ marginBottom: '40px' }}>
            <span className="badge-dot" />
            Women Safety App · V1.0 Launch
          </div>

          <h1 className="font-outfit font-black text-5xl md:text-8xl tracking-tighter text-center w-full leading-[1.05] text-balance" style={{ paddingBottom: '70px' }}>
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-6 justify-center items-center w-full">
            ...
            <div className="store-btn-wrapper relative group">
              <button className="btn btn-glass text-sm px-6 py-4 w-[200px] h-[54px] flex items-center justify-center gap-3 cursor-not-allowed">
