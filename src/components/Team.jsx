...
export default function Team() {
  ...
  return (
    <section ref={sectionRef} id="team" className="pt-[80px] md:pt-[160px] pb-[80px] md:pb-[160px] px-6 bg-transparent relative overflow-hidden z-20 flex flex-col items-center">
      {/* Background glow */}
      ...
      <div className="w-full max-w-7xl mx-auto relative z-10 text-center" style={{ marginBottom: '60px' }}>
        <div
          className="flex flex-col items-center mb-20 mt-10"
          style={{ marginTop: window.innerWidth < 768 ? '100px' : undefined }}
        >
          <div className="badge inline-flex mb-8 px-6 py-2.5 bg-[#111] border border-white/10 text-[#FF1493] text-[10px] tracking-[0.4em] uppercase font-bold rounded-full" style={{ marginTop: window.innerWidth < 768 ? '13px' : undefined, marginTop: '50px' }}>
        ...
        <div className="mb-20 flex justify-center" style={{ marginBottom: '60px' }}>
          <div className="team-card group relative w-48 h-[240px] bg-[#0a0a0a] border border-white/5 rounded-[24px] overflow-hidden hover:border-[#FF1493]/30 transition-all duration-500">
            <div className="h-full w-full p-6 flex flex-col items-center justify-center text-center">
              ...
              {/* Mobile Social Links */}
              <div className="flex md:hidden gap-4 mt-5" style={{ marginTop: window.innerWidth < 768 ? '13px' : undefined }}>
                <a href={mentor.linkedin} target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-[#FF1493] transition-colors">
        ...
        <div className="flex flex-wrap justify-center gap-12 max-w-7xl mx-auto px-4">
          {team.map((member) => (
            <div key={member.name} className="team-card group relative w-[240px] h-[240px] bg-[#0a0a0a] border border-white/5 rounded-[24px] overflow-hidden hover:border-[#FF1493]/30 transition-all duration-500">
              <div className="h-full w-full p-6 flex flex-col items-center justify-center text-center">
                <div className="w-20 h-20 rounded-full border border-white/10 p-1 mb-4 group-hover:scale-105 group-hover:border-[#FF1493]/30 transition-all duration-500">
                  <div className="w-full h-full rounded-full bg-[#111] overflow-hidden flex items-center justify-center">
                    {member.image ? (
                ...
                {/* Mobile Social Links */}
                <div className="flex md:hidden gap-6 mt-2" style={{ marginTop: window.innerWidth < 768 ? '13px' : undefined }}>
                  <a href={member.github} target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors">
                  ...
                  <a href={member.linkedin} target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-[#FF1493] transition-colors">
                    <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.761 0 5-2.239 5-5v-14c0-2.761-2.239-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" /></svg>
                  </a>
                </div>
